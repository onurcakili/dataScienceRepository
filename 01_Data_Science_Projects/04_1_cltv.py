...
# 4. Repeat Rate & Churn Rate (Tekrar ve Kayıp Orn.)        >>>> (birden fazla alışveriş yapan müşteri sayısı / tüm müşteriler)  
...
# 7. Customer Lifetime Value (Müşteri Yaşam Boyu Değeri)        >>>> (CLTV = (customer_value / churn_rate) x profit_margin)  
